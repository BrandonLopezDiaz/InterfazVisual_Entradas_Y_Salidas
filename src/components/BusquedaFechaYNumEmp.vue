...
export default {
    ...
    methods: {
        async consultarpracticantes() {
            ...
            await axios.get('https://localhost:7127/tblEvents/numempyfecha?numemp='+this.form.numero+'&FechaInicio='+this.form.fechainicio+'&FechaFinal='+this.form.fechafinal).then((result) => {
